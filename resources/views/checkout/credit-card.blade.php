...
<body>
    <div class="container">
        <h1 class="text-center">SmartVcard</h1>
        <div class="row">
            <div class="col-md-12">
                <div class="card mx-auto" style="width: 28rem;">
                    <img src="{{ asset('public/assets/images/stripe/ss.png') }}" class="card-img-top p-2" alt="...">
                    <div class="card-body">
                        <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                            data-cc-on-file="false" data-stripe-publishable-key="pk_test_EvYdoBWlIft5rVlbCIMwbywD"
                            id="payment-form">
                            @csrf
